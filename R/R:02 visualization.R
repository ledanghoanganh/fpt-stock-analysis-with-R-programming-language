...
ggsave("output/figures/close_price_professional.png", plot = p_close, width = 11, height = 6.5, dpi = 300)
...
ggsave("output/figures/volume_professional.png", plot = p_volume, width = 11, height = 6.5, dpi = 300)
...
ggsave("output/figures/returns_professional.png", plot = p_returns, width = 11, height = 6.5, dpi = 300)

print("--- Đã vẽ và xuất toàn bộ 3 biểu đồ nâng cao (300 DPI) vào mục output/figures/ ---")
